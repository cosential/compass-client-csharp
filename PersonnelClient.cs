...
using System.Linq;
using System.Net;
using Cosential.Integrations.CompassApiClient.Models;
using RestSharp;

namespace Cosential.Integrations.CompassApiClient
{
    public class PersonnelClient : Client
    {
        public PersonnelClient(int firmId, Guid apiKey, string username, string password, Uri host=null) : base(firmId, apiKey, username, password, host)
        {
        }
